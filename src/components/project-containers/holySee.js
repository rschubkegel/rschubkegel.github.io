...
const HolySeeContainer = (level) => {
  return (
    <ProjectContainer level={ level } title='Website Redesign'>
      <p style={{ marginBottom: '0' }}>The first task of this project was to find a website to redesign. I chose the <Link to='https://www.vatican.va/content/vatican/en.html'>website of the Vatican</Link> for two reasons: 1{')'} I attended an Anglican church throughout college and have an interest in the relationship between traditional Christianity and technology, and 2{')'} the website is severely outdated and in need of renovation. My design process focused on the potential users of the site and how to help them accomplish their goals.</p>
      <h3>User Personas</h3>
