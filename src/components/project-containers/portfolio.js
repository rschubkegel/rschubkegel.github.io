  ...
  return (
    <ProjectContainer level={ level } title='Portfolio Site' linkText='view source' linkDest='https://github.com/rschubkegel/rschubkegel.github.io'>
      ...
      <div className='flex-row' style={{ justifyContent: 'space-around' }}>
        <StaticImage src='../../images/portfolio/gatsby.png' alt='Gatsby.js logo' height={ 128 } />
        <StaticImage src='../../images/portfolio/react.png' alt='React.js logo' height={ 128 } />
        <StaticImage src='../../images/portfolio/sass.png' alt='Sass logo' height={ 128 } />
      </div>
    </ProjectContainer>
  );
};
